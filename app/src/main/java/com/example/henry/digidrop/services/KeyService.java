...
public class KeyService {
    ...
    public static CryptoUtils.KeyWrapper loadMyKeys() {
        return null;
    }

    public static void saveMyKeys(CryptoUtils.KeyWrapper keys) {

    }

    public static void loadForeignPubKey() {

    }

    public static void saveForeignPubKey(String foreignKey) {
